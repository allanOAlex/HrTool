...
[DebuggerStepThrough]internal static class SharedTypeExtensions
{
    public static IndentedStringBuilder AppendWarning(this IndentedStringBuilder sb)
    {
        sb.AppendLine("//---------------------------------------------------------------------------------------");  
    ...
    public static IEnumerable<MemberInfo> GetMembersInHierarchy(this Type type)
    {
        ...
        do
        {
            ...
            foreach (var propertyInfo in currentType.GetRuntimeProperties()
...
#pragma warning restore IDE0034 // Simplify 'default' expression
    ...
    public static bool IsManyToManyJoinEntityType(IEntityType entityType)
    {
