...
public class CSharpDbContextGenerator : ICSharpDbContextGenerator
{
        ...
        bool suppressOnConfiguring)
    {
        ...
        _namespaces.Add("Microsoft.EntityFrameworkCore.Storage");
        ...
        bool suppressOnConfiguring)
    {
        ...
        _builder.AppendLine($"public abstract class {contextName} : DbContext");
        _builder.AppendLine("{");
        ...
        using (_builder.Indent())
        {
            _builder.AppendLine("protected abstract void OnModelCreatingPartial(ModelBuilder modelBuilder);");
        }
        ...
        bool suppressConnectionStringWarning)
    {
        ...
        using (_builder.Indent())
        {
            _builder.AppendLine("ConfigureContext(optionsBuilder);");
        }

        _builder.AppendLine("}");

        _builder.AppendLine("protected abstract void ConfigureContext(DbContextOptionsBuilder optionsBuilder);");
        
        _builder.AppendLine();
    }

    protected virtual void GenerateGetContextTransaction()
    {
        _builder.AppendLine("public abstract IDbContextTransaction GetContextTransaction();");
    }
    /// <summary>
    ///     This is an internal API that supports the Entity Framework Core infrastructure and not subject to
    ///     the same compatibility standards as public APIs. It may be changed or removed without notice in
