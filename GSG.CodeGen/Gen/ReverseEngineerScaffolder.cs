...
public class ReverseEngineerScaffolder : IComplexReverseEngineerScaffolder, IReverseEngineerScaffolder
{
    ...
    public void Save(ScaffoldedFile code, string outputDir, bool overwriteFiles)
    {
        ScaffoldedModel scaffoldedModel = new ScaffoldedModel();
        scaffoldedModel.AdditionalFiles.Add(code);
        CheckOutputFiles(scaffoldedModel, outputDir, overwriteFiles);
        ...
        bool overwriteFiles)
    {
        ...
        if (scaffoldedModel.ContextFile is not null)
        {
